class SiteManagerDanbooru extends SiteManager {
	...
	buildRequestUrl(searchText, pageNumber) {
		...
		let possibleLogin = this.sitesManager.model.danbooruApiKey && this.sitesManager.model.danbooruLogin ? '&login=' + this.sitesManager.model.danbooruLogin + '&api_key=' + this.sitesManager.model.danbooruApiKey : '';

class SlideshowView {
    ...
    attachUiElementListeners() {
        ...
        this.uiElements.includeFavoritesCheckBox.addEventListener('change', function () {
            _this.includeFavoritesChangedEvent.notify();
        });
    ...
    getIncludeFavorites() {
        return this.uiElements.includeFavoritesCheckBox.checked;
    }
    ...
    updateIncludeFavorites() {
        this.uiElements.includeFavoritesCheckBox.checked = this._model.includeFavorites;
    }

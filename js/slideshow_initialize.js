...
document.addEventListener('DOMContentLoaded', function () {
    slideshowController = new SlideshowController({
        ...
        'gelbooruLoginContainer': document.getElementById('gelbooru-login-container'),
        'gelbooruApiKeyContainer': document.getElementById("gelbooru-api-key-container"),
        'gelbooruLogin': document.getElementById('gelbooru-login'),
        'gelbooruApiKey': document.getElementById("gelbooru-api-key"),
        'danbooruLoginContainer': document.getElementById('danbooru-login-container'),
        'danbooruApiKeyContainer': document.getElementById('danbooru-api-key-container'),
        'danbooruLogin': document.getElementById('danbooru-login'),
        'danbooruApiKey': document.getElementById('danbooru-api-key'),
